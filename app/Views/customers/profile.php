              ...
              <div class="tab-content">
                <div class="active tab-pane" id="profile">
                  ...
                  <div class="form-group row">
                    <label for="inputName" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">Nama:</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    <label for="inputHP" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">No. HP:</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    <label for="inputAddr" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">Alamat:</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    <label for="picture" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">Foto profil:</label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="akun">
                  ...
                  <div class="form-group row">
                    <label for="inputUserName" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">Username:</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">Password:</label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="email">
                  ...
                  <div class="form-group row">
                    <label for="inputEmail" class="col-sm-2 col-form-label" style="color: (255, 255, 255, 0.9);">Email:</label>
                    <div class="col-sm-10">
