...
<section id="home-section" class="hero">
  <div class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(<?= base_url('assets/themes/juraganshoes/images/bg_1.jpg') ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Sepatu Terkini Dengan Kualitas Terbaik</h1>
            <h2 class="subheading mb-4">Barang Dijamin Ori</h2>
    ...
    <div class="slider-item" style="background-image: url(<?= base_url('assets/themes/juraganshoes/images/bg_2.jpg') ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Sepatu Kualitas Premium</h1>
            <h2 class="subheading mb-4">Barang Dijamin Ori</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section bg-dark" id="products">
  <div class="container">
      ...
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            ...
            <span>Belanja minimal <?= number_to_currency(1000000, 'IDR', 'id_ID', 2); ?></span>
          </div>
        </div>
      </div>
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            ...
            <span>Dikemas Dari Pabrik Asli</span>
          </div>
        </div>
      </div>
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <h2 class="mb-4">Juragan Sepatu</h2>
        <p style="color: rgba(255, 255, 255, 0.8);"><?= get_settings('store_tagline');
                                                    ?></p>
      </div>
    </div>
  </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            ...
            <div class="product">
              ...
              <div class="text py-3 pb-4 px-3 text-center bg-dark">
                <h3><a style="color: #fff;" href="<?= base_url('shop/product/' . $product['id'] . '/' . $product['sku'] . '/') ?>"><?= $product['name']; ?></a></h3>
                <div class="d-flex">
                  <div class="pricing">
                    <p class="price">
                      <?php if ($product['current_discount'] > 0) : ?>
...
<section class="ftco-section img" style="background-image: url(<?= base_url('assets/themes/juraganshoes/images/bg_3.jpg') ?>);">
  <div class="container">
    <div class="row justify-content-end">
      <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
        <span class="subheading">Produk dengan Harga Terbaik</span>
        <h2 class="mb-4" style="color: #000000;">Deal of the day</h2>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line" style="color: #fff"><?= $review['review_text']; ?></p>
