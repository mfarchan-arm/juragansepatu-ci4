...
<head>
	...
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/open-iconic-bootstrap.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/animate.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/owl.carousel.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/owl.theme.default.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/magnific-popup.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/aos.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/ionicons.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/argon/js/plugins/@fortawesome/fontawesome-free/css/all.min.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/bootstrap-datepicker.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/jquery.timepicker.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/flaticon.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/icomoon.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/juraganshoes/css/style.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/plugins/toastr/toastr.min.css') ?>>

	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery-migrate-3.0.1.min.js') ?>></script>
</head>
...
<body class="goto-here">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdown05">
							...
							<?php elseif (in_groups('admin')) :  ?>
								...
								<a class="dropdown-item" href="<?php echo base_url('logout'); ?>">Logout</a>
							<?php else : ?>
								<a class="dropdown-item" href="<?php echo base_url('login'); ?>">Login & Register</a>
							<?php endif; ?>
						</div>
					</li>
	...
	<script src=<?= base_url('assets/themes/juraganshoes/js/popper.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/bootstrap.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery.easing.1.3.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery.waypoints.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery.stellar.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/owl.carousel.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery.magnific-popup.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/aos.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/jquery.animateNumber.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/bootstrap-datepicker.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/scrollax.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/juraganshoes/js/main.js') ?>></script>
