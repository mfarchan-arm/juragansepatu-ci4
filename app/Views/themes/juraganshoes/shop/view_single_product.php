        ...
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <div class="rating d-flex">
                    ...
                    <p class="text-left mr-4">
                        <a href="#" class="mr-2" style="color: #fff;">100 <span style="color: #bbb;">Rating</span></a>
                    </p>
                    <p class="text-left">
                        <a href="#" class="mr-2" style="color: #fff;"><?php echo $sold->order_qty; ?> <span style="color: #bbb;">Sold</span></a>
                    </p>
                </div>
                <p class="price">
                ...
                <div class="row mt-4">
                    ...
                    <div class="input-group col-md-6 d-flex mb-3">
                        ...
                        <input type="text" id="quantity" name="quantity" class="form-control input-number" value="1" min="1" max="10" style="color: #fff; border-color: #fff;">
                    ...
                    <div class="w-100"></div>
                    <div class="col-md-12">
                        <p style="color: #fff;">Tersedia <?php echo $product->stock; ?> <?php echo $product->product_unit; ?></p>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center bg-dark">
                                <h3><a style="color: #fff;"<?php echo anchor('shop/product/' . $product->id . '/' . $product->sku . '/', $product->name); ?>></a></h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price">
                                            <?php if ($product->current_discount > 0) : ?>
