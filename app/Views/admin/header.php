...
<head>
  ...
  <link rel="stylesheet" href=<?= base_url('assets/themes/argon/css/style.css'); ?> type="text/css">
    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <header>
              ...
              <a href=<?= base_url(); ?>>
                  <span class="image">
                      <img src="<?= get_store_logo();  ?>" >
                  </span>
              </a>
                  <div class="text logo-text">
                  <a style="color: black;" href=<?= base_url(); ?>><span class="name"><?php echo get_store_name(); ?> </span></a>
                  </div>
              </div>
        </header>  
        <div class="ml-auto">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('admin_products/category'); ?>">
                <i class="bx bx bx-category text-info"></i>
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('admin_products/coupons'); ?>">
                <i class="bx bxs-discount text-info"></i>
