...
class Shop extends BaseController
{
    ...
    public function product($id = 0, $sku = '')
    {
        if ($id == 0 || empty($sku)) {
            ...
            if ($this->product->is_product_exist($id, $sku)) {
                ...
                return view('themes\juraganshoes\shop\view_single_product', $product);
            } else {
                throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
            }
        }
    ...
    public function cart()
    {
        ...
        return view('themes\juraganshoes\shop\cart', $data);
    }
    ...
    public function checkout($action = '')
    {
        ...
        switch ($action) {
            ...
            default:
                ...
                return view('themes\juraganshoes\shop\checkout', $params);
                break;
            case 'order':
